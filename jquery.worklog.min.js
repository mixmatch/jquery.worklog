...
c.setStart(b,Math.min(d,b.length)),c.collapse(!0),setTimeout(function(){var a=k.getSelection();a.removeAllRanges();a.addRange(c)},1)}else if(d.keyCode==b.ENTER)return d.stopImmediatePropagation(),"section"===e(this).data("type")&&(a.currentLine!==a.log.sections[e(this).data("index")].length-2?(l.execCommand("insertHTML",!1,"<br><br>"),d=k.getSelection(),d.modify("move","backward","line")):l.execCommand("insertHTML",!1,"<br><br>")),!1}).on("paste",function(a){var b=a.originalEvent;b&&b.clipboardData&&
b.clipboardData.getData&&(b=b.clipboardData.getData("text/plain"),a.preventDefault(),a=b.replace(/\r?\n|\r/g,"<br>"),l.execCommand("insertHTML",!1,a))}).on("input",function(){var b=e(this).data();switch(b.type){case "title":a.log.sections[b.index][0]=this.innerText;break;case "section":var c=a._capitalizeFirst(e(this).html().replace(/(.*)<br>$/i,"$1").split("<br>"));a.log.sections[b.index]=a.log.firstLineTitle?[a.log.sections[b.index][0]].concat(c):c;a.refreshSectionBar(b.index);break;case "sig":a.log.sig=
this.innerText}a.showSuggest=!0;a._trigger("change")}).hover(function(b){"mouseenter"===b.type?e(this).css("background-color","rgba( 255, 255, 255, 0.7)"):e(a.focusedElem).attr("id")!=e(this).attr("id")&&e(this).css("background-color","transparent")}).focus(function(){a.showSuggest=!1;e(this).css("background-color","rgba( 255, 255, 255, 0.7)");a.focusedElem=this}).blur(function(){e(this).css("background-color","transparent");a.currentLine=null;a.focusedElem=null});b.autoSuggest&&e(".autosuggest").autocomplete({source:function(c,
g){var f=c.term.trim(),m=[],h=[],k=[];e.each(a.autoSuggestLines,function(a,c){if(h.length>=b.suggestLength)return!1;var d=c.toLowerCase().indexOf(f.toLowerCase());0===d?c.trim()!==f&&h.push(c):0<d&&k.push(c)});h=h.slice(0,b.suggestLength);k=k.slice(0,b.suggestLength-h.length);m=m.concat(h).concat(k);g(m)},focus:function(a,b){return!1},select:function(b,c){a.setCurrentLine(c.item.value,e(this).data().index);return!1},position:{my:"right top",at:"right bottom"},delay:0,autoFocus:this.options.autoFocus}).focus(function(){a.checkInterval=
setInterval(function(){a._checkCursorPosition()},100)}).blur(function(){clearInterval(a.checkInterval)})},_setTitleFormat:function(){var a=this.log,c=this.options,b=this.nameSpace;e.each(a.sections,function(d,g){if(a.firstLineTitle)switch(c.format){case "html":var f=g[0];c.title.italics&&(f="<i>"+f+"</i>");c.title.underline&&(f="<u>"+f+"</u>");c.title.bold&&(f="<b>"+f+"</b>");e("#"+b+"title"+d).html('<font color="'+c.title.color+'">'+f+"</font>")}})},_capitalizeFirst:function(a){if(Array.isArray(a)){var c=
this;e.each(a,function(b,d){a[b]=c._capitalizeFirst(d)});return a}return a.charAt(0).toUpperCase()+a.slice(1)},refresh:function(){this.$element.text("");this._createTextArea()},addSection:function(a,c){var b=this.options;if(this.log.firstLineTitle)switch(b.format){case "html":var d=c.shift();b.title.italics&&(d="<i>"+d+"</i>");b.title.underline&&(d="<u>"+d+"</u>");b.title.bold&&(d="<b>"+d+"</b>");this.$worklogBody.append(e("<div>",{id:this.nameSpace+"title"+a,"class":"editable"}).append(e('<font color="'+
b.title.color+'">').html(d)).data({type:"title",index:a,base:this}))}c.length&&(this.$worklogBody.append(e("<div>",{id:this.nameSpace+"section"+a+"bar",css:{"float":"left",width:"13px"}})).append(e("<div>",{id:this.nameSpace+"section"+a,"class":"editable autosuggest",css:{overflow:"hidden"},data:{type:"section",index:a,base:this},html:c.join("<br>")+"<br>"})).append("<br>"),this.refreshSectionBar(a))},refreshSection:function(a){var c=e.extend(!0,{},this.log),b=c.sections[a],d=this.options;if(c.firstLineTitle)switch(d.format){case "html":c=
b.shift(),d.title.italics&&(c="<i>"+c+"</i>"),d.title.underline&&(c="<u>"+c+"</u>"),d.title.bold&&(c="<b>"+c+"</b>"),e("#"+this.nameSpace+"title"+a).html(e('<font color="'+d.title.color+'">').html(c))}b.length&&(e("#"+this.nameSpace+"section"+a).html(b.join("<br>")+"<br>"),this.refreshSectionBar(a))},refreshSectionBar:function(a){var c=this,b=e.extend(!0,{},this.log),d=b.sections[a];e("#"+this.nameSpace+"section"+a+"bar").html("");d=d.length;b.firstLineTitle&&d--;for(b=0;b<d;b++)e("#"+this.nameSpace+
"section"+a+"bar").append(e("<span>",{"class":"ui-icon ui-icon-close deleteLine",css:{cursor:"pointer",width:"13px",height:parseInt(e("#"+this.nameSpace+"section"+a).css("height"),10)/d},data:{section:a,line:b}}));e("#"+this.nameSpace+"section"+a+"bar").css("height",e("#"+this.nameSpace+"section"+a).css("height"));e(".deleteLine").off("click").on("click",function(){var a=e(this).data();c.removeLine(a.section,a.line)})},findLineInSection:function(a,c,b,d){""===a&&(a="^$");var g=new RegExp(a,"i");a=
this.log.sections[c];b=null!=b?b:0;d=null!=d?d:a.length;var f=!1;if("string"===typeof b){b=this.findLineInSection(b,c);if(!1===b)return!1;b++}if("string"===typeof d&&(d=this.findLineInSection(d,c),!1===d))return!1;e.each(a,function(a,c){if(g.test(c)&&a>=b&&a<d)return f=a,!1});return f},findLine:function(a,c,b,d){var g=this,f=!1;null!=c?f=this.findLineInSection(a,c,b,d):e.each(this.log.sections,function(e,h){f=g.findLineInSection.apply(g,[a,e,b,d]);if(!1!==f)return c=e,!1});return!1!==f?{section:c,
line:f}:!1},addLine:function(a,c,b){a=this._capitalizeFirst(a);c=null!=c?c:this.log.sections.length-1;var d=this.log.sections[c];null==b&&(""===d[d.length-1]&&d.pop(),b=d.length);Array.isArray(a)?d=d.slice(0,b).concat(a).concat(d.slice(b)):d.splice(b,0,a);this.log.sections[c]=d;this.refreshSection(c);this._trigger("change")},setLine:function(a,c,b){c=this._capitalizeFirst(c);this.log.sections[b][a]=c;this.refreshSection(b);this._trigger("change")},setCurrentLine:function(a,c){var b=this.currentLine;
this.log.firstLineTitle&&b++;this.setLine.apply(this,[b,a,c])},replace:function(a,c,b,d,g){var f=this.findLine(a,b,d,g),k=this;return!1!==f?(a=new RegExp(a,"i"),b=this.log.sections[f.section][f.line],Array.isArray(c)?(a=b.replace(a,c.shift()),this.setLine(f.line,a,f.section),e.each(c,function(a,b){k.addLine(b,f.section)})):(a=b.replace(a,c),this.setLine(f.line,a,f.section)),f):!1},replaceLine:function(a,c,b,d,e){a=this.findLine(a,b,d,e);return!1!==a?(this.setLine(a.line,c,a.section),a):!1},removeLine:function(a,
c){var b=this.log.sections[a].length;this.log.firstLineTitle&&(c++,b--);1<b?this.log.sections[a].splice(c,1):this.log.sections[a][c]="";this.refreshSection(a)},toArray:function(a){var c=[],b=e.extend(!0,{},this.log),d=this.options;if(null==a)e.each(b.sections,function(a,g){if(b.firstLineTitle)switch(d.format){case "html":var h=g.shift();d.title.italics&&(h="<i>"+h+"</i>");d.title.underline&&(h="<u>"+h+"</u>");d.title.bold&&(h="<b>"+h+"</b>");c.push('<font color="'+d.title.color+'">'+h+"</font>")}g.length&&
(e.merge(c,g),c.push(""))}),null!=b.sig&&c.push("<b>"+b.sig+"</b>");else{if(b.firstLineTitle)switch(d.format){case "html":var g=b.sections[a].shift();d.title.italics&&(g="<i>"+g+"</i>");d.title.underline&&(g="<u>"+g+"</u>");d.title.bold&&(g="<b>"+g+"</b>");c.push('<font color="'+d.title.color+'">'+g+"</font>")}b.sections[a].length&&e.merge(c,b.sections[a])}return c},value:function(a){return this.toArray(a).join("\n")},logObj:function(){return this.log}})})(jQuery,window,document);
